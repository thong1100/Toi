...
def check_proxy(proxy):
    ...
    print(f" \033[1;37m[\033[1;31mThong\033[1;37m] \033[1;37m{proxy} \033[1;31m• \033[1;37mUnknown/Unknown \033[1;31m• \033[1;31mBAD")
    return False
...
def detect_location(proxy):
    ...
    if response.status_code == 200:
        ...
        if data["status"] == "success":
            print(f" \033[1;37m[\033[1;31mThong\033[1;37m] \033[1;37m{proxy} \033[1;31m• \033[1;37m{data['country']}/{data['city']} \033[1;31m• \033[1;32mLIVE")
            open(luu,'a').write(proxy+'\n')
        else:
            print(" \033[1;37m[\033[1;31mThong\033[1;37m] \033[1;31mFailed to detect location for proxy.")
